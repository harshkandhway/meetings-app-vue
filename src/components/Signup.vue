        ...
        <div class="sign-in-container">
            ...
            <div class="sign-in-form">
                <form @submit.prevent="signIn">
                    <input type="email" name="femail" id="femail" placeholder="Email" class="fdetail" v-model="formLogin.email" autocomplete="on">
                    <input type="password" name="fpassword" id="fpassword" placeholder="Password" class="fdetail" v-model="formLogin.password" autocomplete="on">
        ...
        <div class="suc sign-up-container">
            ...
            <div class="sign-up-form">
                <form @submit.prevent="signUp">
                    <input type="text" name="fname" placeholder="Name" class="fdetail" v-model="formRegister.name">
                    <input type="email" name="femail" class="fdetail" placeholder="Email" v-model="formRegister.email">
                    <input type="password" name="fpassword" class="fdetail" placeholder="Password" autocomplete="on" v-model="formRegister.password">
